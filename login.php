	...
	<div class="container login_form">
		<div class="row justify-content-center">
			<div class="col-8 mt-4 mb-4">
				...
				<form class="my-2" method="post" action="login.html">
					<div class="mb-3">
					...
					<div class="row justify-content-between mt-3"  >
						<button type="submit" style='margin: 0 12px 0 12px;' class=" col-4 btn btn-secondary">Войти</button>
						<a href="./reg.html" style='margin: 0 12px 0 12px;' class=" col-4  btn btn-light ">Зарегистироваться</a>
					</div>
				</form>
			</div>
		</div>
